package at.htl.easygrow.view.activities;
...
public class MainActivity extends AppCompatActivity
    ...
    public void loadPreferences() {
        ...
        plant.setIp(preferences.getString(getString(R.string.saved_ip), getString(R.string.saved_ip_default)));
        plant.setMoistureOptimum(preferences.getInt(getString(R.string.saved_moisture_optimum),
                getResources().getInteger(R.integer.saved_moisture_optimum_default)));
        plant.setHumidityOptimum(preferences.getInt(getString(R.string.saved_humidity_optimum),
                getResources().getInteger(R.integer.saved_humidity_optimum_default)));
        plant.setTemperatureOptimum(preferences.getInt(getString(R.string.saved_temperature_optimum),
                getResources().getInteger(R.integer.saved_temperature_optimum_default)));
    }
    ...
    public void savePreferences() {
        ...
        editor.putString(getString(R.string.saved_ip), plant.getIp());
        editor.putInt(getString(R.string.saved_moisture_optimum), plant.getMoistureOptimum());
        editor.putInt(getString(R.string.saved_humidity_optimum), plant.getHumidityOptimum());
        editor.putInt(getString(R.string.saved_temperature_optimum), plant.getTemperatureOptimum());
        editor.commit();
    }
}
